...
python train_svi_dance.py \
--learning_rate 1e-4 \
--lora_rank 128 \
--lora_alpha 128 \
--dataset_path data/toy_train/svi-dance/preprocessed/ \
...
--pretrained_lora_path ./weights/UniAnimate-DiT/UniAnimate-Wan2.1-14B-Lora-12000.ckpt \
--max_epochs 20 \
--train_architecture lora \
--use_gradient_checkpointing \
--use_gradient_checkpointing_offload \
--training_strategy "deepspeed_stage_2" \
--output_path "./experiments/train/svi-dance/" \
--use_error_recycling \
--error_buffer_k 500 \
--y_error_num 1 \
--num_motion_frames 1 \
