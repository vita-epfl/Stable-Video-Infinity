...
<a href="https://www.modelscope.cn/models/epfl-vita/svi-model"><img src="https://img.shields.io/badge/ModelScope-Models-624aff?logo=modelscope" /></a>
<a href="https://www.modelscope.cn/datasets/epfl-vita/svi-benchmark"><img src="https://img.shields.io/badge/ModelScope-Datasets-624aff?logo=modelscope" /></a>
...
## 🚀 [27 May 2026] Update EverAnimate

- [EverAnimate](https://everanimate.github.io/homepage/): A long-range human animation method based on SVI 2.0 Pro. Have a try!

- [SVI `main branch`](https://github.com/vita-epfl/Stable-Video-Infinity#): Wan 2.1 base model (both SVI 1.0/2.0)

- [SVI `svi_wan22 branch`](https://github.com/vita-epfl/Stable-Video-Infinity/tree/svi_wan22): Wan 2.2 base model (both SVI 2.0/2.0 Pro)


## ✨ SVI 2.0 Pro ComfyUI Workflows and Videos Generated by Community Users
...
- **Enhance prompts & reduce LightX2V usage & use more optimal resolution (480p) to relieve slow motion.**
...
*Stable Video Infinity* (SVI) is able to generate ANY-length videos with high temporal consistency, plausible scene transitions, and controllable streaming storylines in ANY domain.
...
If you can’t wait for the official ComfyUI release, try the testing versions of the Shot and Film workflows first with commercial GPUs based on quantization and distilled LoRAs: [Here](https://github.com/kijai/ComfyUI-WanVideoWrapper/issues/1519#issuecomment-3447933556). The official one (more stable) might be updated soon. Due to model quantization, the video quality may be affected (Better to try more sampling steps than 4/8). 
...
- [10-31-2025] Official SVI-Shot ComfyUI workflow! 
- [10-23-2025] Preview of Wan 2.2-5B-SVI and some tips for custom SVI implementation: See [DevLog](docs/DevLog.md)!  
- [10-21-2025] The error-banking strategy is optimized, further improving the stability. See details in [DevLog](docs/DevLog.md)!  
...
<div align="center">
    <img src="docs/causal.png" alt="Paradigm comparison">
</div>
...
| ------------------------------- | ----------------------- | -------------------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| **SVI-2.0**              | Single-scene (supports some transitions) | Image + Text prompt stream        | Long video       | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-2.0/SVI_Wan2.1-I2V-14B_lora_v2.0.safetensors?download=true) [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-2.0%2FSVI_Wan2.1-I2V-14B_lora_v2.0.safetensors?status=2)            | Generate consistent long video with 1 text prompt stream.                                 |                          
| **ALL SVI-1.0**                   | Infinite possibility    | Image + X                  | X video          | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/tree/main/version-1.0) [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/tree/master/version-1.0)                                                  | Family bucket! I want to play with all!                                                                    |
| **SVI-Shot**              | Single-scene generation | Image + Text prompt        | Long video       | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-1.0/svi-shot.safetensors?download=true)  [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-1.0%2Fsvi-shot.safetensors?status=2)           | Generate consistent long video with 1 text prompt. (This will never drift or forget in our 20 min test)                                 |
| **SVI-Film-Opt-10212025**  (Latest)            | Multi-scene generation  | Image + Text prompt stream | Film-style video | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-1.0/svi-film-opt-10212025.safetensors) [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-1.0%2Fsvi-film-opt-10212025.safetensors?status=2)            | Generate creative long video with 1 text prompt stream (5 second per text).                                |
| **SVI-Film**              | Multi-scene generation  | Image + Text prompt stream | Film-style video | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-1.0/svi-film.safetensors?download=true) [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-1.0%2Fsvi-film.safetensors?status=2)            | Generate creative long video with 1 text prompt stream (5 second per text).                                |
| **SVI-Film (Transition)** | Multi-scene generation  | Image + Text prompt stream | Film-style video | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-1.0/svi-film-transitions.safetensors?download=true) [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-1.0%2Fsvi-film-transitions.safetensors?status=2) | Generate creative long video with 1 text prompt stream. (More scene transitions due to the training data)  |
| **SVI-Tom&Jerry**         | Cartoon animation       | Image                      | Cartoon video    | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-1.0/svi-tom.safetensors?download=true) [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-1.0%2Fsvi-tom.safetensors?status=2)             | Generate creative long cartoon videos with 1 text prompt stream (This will never drift or forget in our 20 min test) |
| **SVI-Talk**              | Talking head            | Image + Audio              | Talking video    | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-1.0/svi-talk.safetensors?download=true)  [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-1.0%2Fsvi-talk.safetensors?status=2)           | Generate long videos with audio-conditioned human speaking   (This will never drift or forget in our 10 min test)                                              |
| **SVI-Dance**             | Dancing animation       | Image + Skeleton           | Dance video      | [🤗 Huggingface](https://huggingface.co/vita-video-gen/svi-model/resolve/main/version-1.0/svi-dance.safetensors?download=true)  [🤖 Modelscope](https://www.modelscope.cn/models/epfl-vita/svi-model/file/view/master/version-1.0%2Fsvi-dance.safetensors?status=2)          | Generate long videos with skeleton-conditioned human dancing                                               |

Note: If you want to play with T2V, you can directly use SVI with an image generated by any T2I model!

### SVI-2.0

For this model, you can try the sample in [100-prompt-sample](data/toy_test/svi_2.0) with SVI-Shot inference script. It should generate results similar to the ones shown in our 14-min YouTube video.
